...
export type ThreadComponents = {
  ...
  /** Slot rendu dans la barre d'actions du Composer (ex. sélecteur de modèle). */
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-8 flex flex-col items-start px-2 text-left">
      <span className="text-muted-foreground font-mono text-[11px] tracking-[0.1em] uppercase">
        assistant
      </span>
      <h1 className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-foreground mt-2 text-2xl font-medium tracking-tight duration-200 motion-reduce:animate-none">
        Prêt à réviser ?
      </h1>
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-muted text-foreground rounded-[var(--radius-thread)] px-4 py-2 wrap-break-word empty:hidden">
