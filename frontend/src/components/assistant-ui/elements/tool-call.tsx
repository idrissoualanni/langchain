...
const collapsePanel =
  "h-(--collapsible-panel-height) overflow-hidden transition-[height] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] data-[starting-style]:h-0 data-[ending-style]:h-0 motion-reduce:transition-none";
...
/** Carte pliante d'un appel d'outil (élément officiel Assistant UI adapté).
 *  Trigger : libellé (actif pendant le run) + requête ; contenu : request/result. */
