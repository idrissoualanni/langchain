...
# Racine sandbox : backend/data/workspace/files (parents[3] depuis
# app/mcp/servers/filesystem_server.py). Déterministe quel que soit le
# CWD du subprocess MCP ; MCP_FS_ROOT permet l'override (tests).
