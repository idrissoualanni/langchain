...
# FIX REVUE + REFACTOR : knowledge vit dans backend/app/knowledge,
# ce fichier dans backend/app/services/context/ → parents[0]=context,
# parents[1]=services, parents[2]=app
