...
#
# Déplacé depuis app/context/schemas.py (refactor : les contrats
# vivent dans app/schemas/). Contenu INCHANGÉ — les imports internes
# (budget, model_capabilities, learning) seront repointés quand ces
# modules migreront vers app/services/.
...
from app.schemas.budget import ContextBudget
