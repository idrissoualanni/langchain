# Video Schemas — domaine ingestion vidéo.
#
# Déplacé depuis app/graph/subgraphs/video/schemas.py (refactor).
# Le contrat de SORTIE du workflow (VideoResult) vit dans
