# Problem Schemas — domaine résolution d'énoncés (§21).
#
# Déplacé depuis app/graph/subgraphs/problem/schemas.py (refactor).
# Types purs du domaine (aucune logique de graphe). Le contrat de
# SORTIE du workflow (ProblemResult) vit dans app/schemas/workflow.py.
...
StepVerdict = Literal["correct", "incorrect", "hint", "unclear"]
